...
@section('title', 'Sign In - SmartTravel')
        ...
        <div class="tt-auth-card" data-aos="fade-up">
            ...
            <form method="POST" action="{{ route('login') }}" class="tt-form">
                ...
                <div class="tt-form-group">
                    ...
                    <input id="username" type="text" class="tt-input @error('username') is-invalid @enderror"
                ...
                <div class="tt-form-group">
                    ...
                    <input id="password" type="password" class="tt-input @error('password') is-invalid @enderror"
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" style="color:var(--tt-primary);font-size:.85rem;">Forgot
                            Password?</a>
                    @endif
                </div>
                ...
                <div class="text-center my-3">
                    <small class="text-muted">New to SmartTravel?</small>
                </div>
            ...
            <div class="text-center mt-4">
                <small class="text-muted">&copy; {{ date('Y') }} SmartTravel. Experience Bangladesh differently.</small>
            </div>
        </div>
    </div>
@endsection
