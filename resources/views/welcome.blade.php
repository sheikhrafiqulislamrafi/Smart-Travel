...
@section('page')
        ...
        <div class="container tt-hero-content">
            <div class="row align-items-center">
                <div class="col-lg-7" data-aos="fade-right">
                    <div class="tt-badge">
                        <span>Authentic Bangladeshi Experiences</span>
                    </div>

                    <h1 class="tt-hero-title">
                        Discover the Soul of <span class="accent">Asia</span>
                    </h1>

                    <p class="tt-hero-text">
                        Embark on extraordinary journeys through Bangladesh's untamed wilderness,
                    ...
                    <div class="tt-trust-row">
                        ...
                        <div class="tt-trust-item">
                            ...
                            <div>
                                <div class="tt-trust-value">4.5/5</div>
                                <div class="tt-trust-label">2,000+ Reviews</div>
                            </div>
                        </div>
                        <div class="tt-trust-item">
                            <div class="tt-trust-icon"><i class="fas fa-award"></i></div>
                            <div>
                                <div class="tt-trust-value">5+ Years</div>
                ...
                <div class="col-lg-5 d-none d-lg-block" data-aos="fade-left" data-aos-delay="200">
                    <div class="tt-hero-card">
                        <img src="{{ asset('images/destination-10.jpg') }}" alt="Maasai Mara Safari" loading="eager">
                        <div class="tt-hero-card-body">
                            ...
                            <div class="tt-hero-card-footer">
                                <div>
                                    ...
                                    <div class="price-value">BDT 10,000</div>
                                </div>
    ...
    <section class="tt-section">
        <div class="container">
            <div class="tt-section-header text-center" data-aos="fade-up">
                ...
                <p class="tt-subtitle">
                    Explore Bangladesh's most captivating locations, curated by our local experts
                            ...
                            <div class="tt-dest-card-footer">
                                <div>
                                    ...
                                    <div class="tt-dest-price-value">
                                        ...
                                        BDT {{ number_format($numericPrice) }}
                                    </div>
                                </div>
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="tt-features-img">
                        <img src="{{ asset('images/about.jpg') }}" alt="Bangladesh Wildlife">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="tt-section-header">
                        <div class="tt-pretitle">Why Choose SmartTravel</div>
                        <h2 class="tt-title">Experience Bangladesh with <span class="accent">Local Experts</span></h2>
                        <p class="tt-subtitle">
                            As proud Bangladeshi, we don't just show you destinations — we share our homeland with you.
                        </p>
                    </div>
                    ...
                    <div class="tt-feature-item">
                        ...
                        <div>
                            ...
                            <p>Born and raised in Bangladesh, we know every hidden gem, cultural nuance, and breathtaking
                                vista.</p>
                        </div>
                    </div>
                    <div class="tt-feature-item">
                    ...
                    <div class="tt-feature-item">
                        ...
                        <div>
                            ...
                            <p>We partner with local communities and support conservation efforts across Bangladesh.</p>
                        </div>
                    </div>
                    <div class="tt-feature-item">
    ...
    <section class="tt-section">
        <div class="container">
            <div class="tt-section-header text-center" data-aos="fade-up">
                ...
                <h2 class="tt-title">Stories from the <span class="accent">Tourist</span></h2>
            </div>
            ...
            <div class="tt-testimonials-grid">
                ...
                <div class="tt-testimonial-card" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="tt-testimonial-text">
                        "SmartTravel showed us the real Bangladesh. From wildlife safaris to cultural villages,
                ...
                <div class="tt-testimonial-card" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="tt-testimonial-author">
                        <img src="{{ asset('images/destination-8.jpg') }}" alt="Emma S" class="tt-testimonial-avatar">
                        <div>
    ...
    <section class="tt-cta">
        <div class="container" data-aos="zoom-in">
            ...
            <h2>Ready to Begin Your Bangladeshi Adventure?</h2>
            <p>
                Let our local experts craft your perfect journey. From wildlife safaris to coastal escapes,
                cultural immersions to mountain treks — your dream Bangladeshi experience awaits.
            </p>
