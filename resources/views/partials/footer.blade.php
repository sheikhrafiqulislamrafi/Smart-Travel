    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <h4 class="mb-0">Smart<span class="brand-accent" style="color:var(--tt-accent)">Travel</span></h4>
                </div>
                <p class="mb-3">
                    Your trusted local guide to Bangladesh's most incredible destinations.
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="contact-row">
                    ...
                    <span>Shibari H tower<br>Khulna, Bangladesh</span>
                </div>
                <div class="contact-row">
                    <i class="fas fa-phone"></i>
                    <span>+880 17900-11648</span>
                </div>
                <div class="contact-row">
                    <i class="fas fa-envelope"></i>
                    <span>smarttravel@smarttravel.com</span>
                </div>
            </div>
        </div>
        ...
        <div class="tt-footer-bottom">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p>&copy; {{ date('Y') }} SmartTravel . All rights reserved.</p>
                </div>
