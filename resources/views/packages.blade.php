...
@section('title', 'Tour Destinations - SmartTravel')
...
@section('page')
    ...
    <section class="tt-page-hero">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <h1 class="tt-page-title">Discover Bangladesh's <span class="accent">Wonders</span></h1>
            <p class="tt-page-subtitle">
                From the wild mangrove forest of Sundarbans to the pristine beaches of Cox's Bazar,
                explore our handpicked destinations that showcase Bangladesh's natural beauty.
            </p>
        </div>
    </section>
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-lg-4">
                            <div class="tt-form-group">
                                ...
                                <input type="text" class="tt-input" name="search" placeholder="Where do you want to go?"
                        ...
                        <div class="col-lg-3">
                            <div class="tt-form-group">
                                ...
                                <select class="tt-select" name="price_range">
                                    ...
                                    <option value="0-10000" {{ request('price_range') == '0-10000' ? 'selected' : '' }}>
                                        Under BDT 10,000</option>
                                    <option value="10000-20000"
                                        {{ request('price_range') == '10000-20000' ? 'selected' : '' }}>BDT 10,000 - 20,000
                                    </option>
                                    <option value="20000-50000"
                                        {{ request('price_range') == '20000-50000' ? 'selected' : '' }}>BDT 20,000 - 50,000
                                    </option>
                                    <option value="50000+" {{ request('price_range') == '50000+' ? 'selected' : '' }}>Over
                                        BDT 50000</option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="tt-section-header text-center" data-aos="fade-up">
                ...
                <p class="tt-subtitle">
                    @if ($destinations->count() > 0)
                        Showing {{ $destinations->count() }} amazing Bangladeshi destinations
                    @else
            ...
            @if ($destinations->count() > 0)
                <div class="tt-dest-grid">
                    @foreach ($destinations as $destination)
                        <article class="tt-dest-card" data-aos="fade-up"
