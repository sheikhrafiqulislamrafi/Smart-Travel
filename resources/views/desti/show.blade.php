...
@section('title', $destinations->title . ' - SmartTravel ')
		...
		<div class="row g-4">
			...
			<div class="col-lg-4">
				...
				<div class="tt-sidebar-card mb-4" data-aos="fade-left">
					...
					<div class="tt-price-amount">BDT {{ number_format($destinations->price) }}</div>
				...
				<div class="tt-sidebar-card text-center" data-aos="fade-left">
					...
					<a href="tel:+8801790011648" class="btn-tt-primary w-100 mb-2"><i class="fas fa-phone me-2"></i> +880 17900-11648</a>
