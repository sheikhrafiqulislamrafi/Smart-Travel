...
@section('title', 'Contact Us - SmartTravel')
...
@section('page')
    ...
    <section class="tt-page-hero">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <p class="tt-page-subtitle">Ready to explore Bangladesh's wonders? We're here to help you plan the perfect
                adventure.</p>
        </div>
    </section>
            ...
            <div class="row g-4" data-aos="fade-up">
                <div class="col-md-6 col-lg-3">
                    <div class="tt-contact-card text-center">
                        ...
                        <p>Shibbari H Tower<br>Khulna, Bangladesh</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="tt-contact-card text-center">
                        ...
                        <h5>Call Us</h5>
                        <p><a href="tel:+8801790011648">+880 17900-11648</a><br>Saturday - Thursday: 8AM - 6PM</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="tt-contact-card text-center">
                        ...
                        <h5>Email Us</h5>
                        <p><a href="mailto:smarttravel@smarttravel.com">smarttravel@smarttravel.com</a><br>We reply within
                            24 hours</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="tt-contact-card text-center">
                        ...
                        <h5>Live Chat</h5>
                        <p>Available Sat - Thur<br>9AM - 5PM </p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    @if (Session::has('success'))
                        <div class="alert alert-success"><i
                                class="fas fa-check-circle me-2"></i>{{ Session::get('success') }}</div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('contact.store') }}" class="tt-form">
                        ...
                        <div class="tt-form-group">
                            ...
                            <input type="text" name="name"
                                class="tt-input {{ $errors->has('name') ? 'is-invalid' : '' }}"
                        ...
                        <div class="tt-form-group">
                            ...
                            <input type="text" name="subject"
                                class="tt-input {{ $errors->has('subject') ? 'is-invalid' : '' }}"
                        ...
                        <div class="tt-form-group">
                            ...
                            <textarea name="message" class="tt-textarea {{ $errors->has('message') ? 'is-invalid' : '' }}" rows="6"
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="tt-contact-card text-center p-3">
                                ...
                                <h6>Easy to Find</h6>
                                <small>Center of Shibbari</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="tt-contact-card text-center p-3">
                    ...
                    <div class="accordion tt-accordion" id="faqAccordion" data-aos="fade-up">
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#faq1">How far in advance should I book my
                                    safari?</button></h2>
                            <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">We recommend booking at least 3-6 months in advance, especially
                                    for peak season (July-October and December-February). However, we can accommodate
                                    last-minute bookings based on availability.</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#faq2">What's included in the tour
                                    packages?</button></h2>
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">Our packages typically include accommodation, meals, park fees,
                                    professional guide, game drives, and airport transfers. Specific inclusions vary by
                                    package.</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#faq3">Do you offer customized
                                    itineraries?</button></h2>
                            <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">Absolutely! We specialize in tailor-made experiences. Contact
                                    us with your preferences, budget, and travel dates, and we'll craft the perfect
                                    Bangladeshi adventure.</div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            <h2 class="accordion-header"><button class="accordion-button collapsed" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#faq4">What payment methods do you
                                    accept?</button></h2>
                            <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">We accept bKash, Nagad, bank transfers, credit/debit cards via
                                    Stripe, and international wire transfers. A deposit is typically required to confirm
                                    your booking.</div>
                            </div>
                        </div>
                    </div>
    ...
    @push('scripts')
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&callback=initMap" async
            defer></script>
        <script>
            function initMap() {
                const loc = {
                ...
                const info = new google.maps.InfoWindow({
                    content: '<div style="padding:.75rem"><strong>SmartTravel</strong><br>Ole Sangale Road, Nairobi<br><span style="color:var(--tt-primary)">+254 712 345 678</span></div>'
                });
