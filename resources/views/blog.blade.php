...
@section('title', 'Blog - SmartTravel')
...
<section class="tt-page-hero">
	...
	<div class="container" data-aos="fade-up">
		...
		<h1 class="tt-page-title">Bangladesh Travel <span class="accent">Stories</span></h1>
		<p class="tt-page-subtitle">
			Discover insider tips, travel stories, and hidden gems across Bangladesh's stunning landscapes and rich culture.
		</p>
	</div>
</section>
...
<section class="tt-section">
	<div class="container">
		<div class="tt-section-header text-center" data-aos="fade-up">
			...
			<p class="tt-subtitle">Get inspired by authentic travel experiences and expert tips from our Bangladesh adventures.</p>
		</div>
			...
			<article class="tt-blog-card" data-aos="fade-up" data-aos-delay="{{ ($loop->iteration % 3) * 100 }}">
				...
				<div class="tt-blog-card-body">
					<div class="tt-blog-card-meta">
						...
						<span><i class="fas fa-user"></i> SmartTravel Team</span>
					</div>
					<h3 class="tt-blog-card-title">
						<a href="#">{{ $blog->title }}</a>
					</h3>
					<p class="tt-blog-card-desc">
						{{ Str::limit($blog->description ?? 'Discover amazing travel experiences and insights that will inspire your next Bangladesh adventure.', 150) }}
					</p>
...
<section class="tt-newsletter" data-aos="zoom-in">
	<div class="container">
		<div class="tt-newsletter-inner">
			...
			<h2>Stay Updated with Bangladesh Travel Tips</h2>
